...
export const menuIconOptions: ReadonlyArray<MenuIconOption> = [
  icon("send", "发送", "Send", "tools", SendIcon),
  icon("boxes", "应用", "Apps", "tools", BoxesIcon),
  icon("radio", "广播", "Radio", "tools", RadioIcon),
  icon("app-window", "应用接入", "Applications", "tools", AppWindowIcon),
  icon("history", "历史", "History", "monitor", HistoryIcon),
  icon("contact", "联系人", "Contacts", "organization", ContactIcon),
