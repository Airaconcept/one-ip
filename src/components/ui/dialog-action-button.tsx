...
type DialogShortcutKind = DialogActionKind | "test";
type DialogActionTone = DialogActionKind | "destructive";
type ShortcutKind = DialogShortcutKind | "none";
...
function useDialogActionShortcut({
  ...
  React.useEffect(() => {
    ...
    const activeShortcut: DialogShortcutKind = shortcut;
...
function matchesShortcut(event: KeyboardEvent, shortcut: DialogShortcutKind) {
  if (shortcut === "confirm") {
    return (
